...
# this lesson is about LOGICAL OPPERATORS click EVIL PATRICIA out too!
...
#USE OR Logical Opporator

if user == "Ben" or user == "Patricia" or user == "Loki":
    ...
    #USE AND OPORATOR
    # if good deeds are less then 4, continue
    if (evil_status == "y" and good_deeds < 4):
        print (type(evil_status))
        print("Please leave "+ user + "! You are not welcome here.\n")
